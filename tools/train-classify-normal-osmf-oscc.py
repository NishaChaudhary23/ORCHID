...
def model(masterpath, model_type):
        ...
        for fold in range (0,3):
                ...
                filepath = filepath + "/model-{epoch:02d}.keras"
                ...
                history = model.fit(train_generator, validation_data = valid_generator, epochs=50, callbacks=[callbacks], verbose=1)
                print("------------------------------------------")
                print(f'Training Complete')
                print("------------------------------------------")

                # Saving the model
                model.save(f'{masterpath}/models/{model_type}/{model_type}_fold_{fold+1}/{model_type}_fold_{fold+1}.keras')
                print("------------------------------------------")
                print(f'Model saved')
                print("------------------------------------------")
                ...
                loaded_model = load_model(f'{masterpath}/models/{model_type}/{model_type}_fold_{fold+1}/{model_type}_fold_{fold+1}.keras')
