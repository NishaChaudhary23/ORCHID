...
# -*- coding: utf-8 -*-
"""
Created on Fri May  3 15:14:27 2024
...
if __name__ == "__main__":
    base_model_dir = '/media/microcrispr8/DATA 1/ORCHID-April24/model-2/models'
    model_folders = ['InceptionV3_fold_1', 'InceptionV3_fold_2', 'InceptionV3_fold_3']
    test_data_directory = '/media/microcrispr8/DATA 1/ORCHID-April24/test/model-2-test-data'
    output_base_dir = '/media/microcrispr8/DATA 1/ORCHID-April24/model-2/model_test_output'
    class_names = ['MDOSCC', 'PDOSCC', 'WDOSCC'] 
